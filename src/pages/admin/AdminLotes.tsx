            ...
            <div className="space-y-4">
              ...
              <div><Label>Status</Label>
                <select className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm" value={form.status} onChange={(e) => setForm({ ...form, status: e.target.value })}>
                  <option value="disponivel">Disponível</option><option value="esgotado">Esgotado</option><option value="embreve">Em breve</option><option value="indisponivel">Indisponível</option>
                </select>
              </div>
