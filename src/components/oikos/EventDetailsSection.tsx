          ...
          <div className="flex flex-col justify-start h-full max-w-[540px] mx-auto md:mx-0">
            ...
            <div className="flex items-center gap-3 md:gap-4 flex-nowrap md:flex-wrap">
              ...
              <div className="flex flex-col items-start md:hidden shrink-0">
                ...
                <span className="font-display text-4xl font-bold text-[#19C971] leading-none">
                  17+
                </span>
                <span className="text-[10px] uppercase font-bold tracking-wide text-[#393939] leading-tight">
                  ATÉ 25 ANOS
                </span>
              </div>
            </div>
            ...
            <div className="flex items-start gap-10 md:gap-14">
              ...
              <div className="hidden md:flex flex-col ml-auto items-start">
                <span className="text-xs font-bold md:text-sm uppercase tracking-widest text-[#393939]">
                  NOVA FAIXA ETÁRIA
                </span>
                <span
