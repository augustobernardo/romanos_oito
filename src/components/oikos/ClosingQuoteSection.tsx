...
const ClosingQuoteSection = () => {
  return (
    ...
    // <footer className="relative bg-black py-32 md:py-20 px-6 md:px-12 overflow-hidden flex flex-col items-center justify-center min-h-[60vh]">
    ...
    //       <h2 className="font-script text-7xl md:text-8xl lg:text-10xl italic text-[6rem] md:text-[10rem] leading-[0.8] text-white transform -rotate-6 drop-shadow-[0_10px_20px_rgba(0,0,0,0.8)]">
    //         Somos<br/>Filhos
    //       </h2>
    //     </div>
